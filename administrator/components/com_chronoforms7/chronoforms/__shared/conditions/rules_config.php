					...
					'r1' => [
						[
							...
							'params' => [
								...
								'origin' => ['name' => 'Connection['.$utype.']['.$n.'][conditions][#conditions#][rules][#rules#][first]']
							],
						],
						[
							'width' => 'three wide', 
							...
							'params' => [
								...
								'origin' => ['name' => 'Connection['.$utype.']['.$n.'][conditions][#conditions#][rules][#rules#][sign]']
							],
						],
						[
							...
							'params' => [
								...
								'origin' => ['name' => 'Connection['.$utype.']['.$n.'][conditions][#conditions#][rules][#rules#][second]']
							],
						],
						[
							...
							'params' => [
								...
								'origin' => ['name' => 'Connection['.$utype.']['.$n.'][conditions][#conditions#][rules][#rules#][msecond][]']
							],
						],
						[
							'width' => 'two wide', 
