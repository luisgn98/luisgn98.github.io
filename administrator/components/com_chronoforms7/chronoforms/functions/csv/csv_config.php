...
<div class="field">
	...
	<?php $this->view(dirname(__FILE__).DS.'csv_columns_config.php', ['unit' => $unit, 'utype' => $utype, 'n' => $n]); ?>
	<small><?php el3('Choose which fields from the data provider you want to be included as columns in the CSV file.'); ?></small>
</div>
...
<div class="equal width fields">
	...
	<div class="field">
		<label><?php el3('Delimiter'); ?></label>
		<input type="text" value="," name="Connection[<?php echo $utype; ?>][<?php echo $n; ?>][delimiter]">
	</div>
...
<div class="equal width fields">
	<div class="field">
		...
		<input type="text" value="{path:front}<?php echo DS.'files'.DS.'csv'.$n.'.csv'; ?>" name="Connection[<?php echo $utype; ?>][<?php echo $n; ?>][file_path]">
	</div>
