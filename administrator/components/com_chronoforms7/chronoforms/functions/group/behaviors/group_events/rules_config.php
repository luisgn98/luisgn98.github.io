...
<?php $this->view($this->get('cf.paths.shared').'clonable'.DS.'clonable.php', [
		...
		// 'btns' => ['switch_events' => ['main' => ['text' => rl3('Add New Condition')]]],
		'visible' => ['rules' => 1],
				...
				'main' => [
					'r1' => [
						[
							'width' => 'six wide', 
							'params' => [
								'placeholder' => rl3('Value 1'), 
								'origin' => ['name' => 'Connection['.$utype.']['.$n.'][switch_events][#switch_events#][rules][#rules#][first]']
							],
						],
						[
							'width' => 'three wide', 
							...
							'params' => [
								...
								'origin' => ['name' => 'Connection['.$utype.']['.$n.'][switch_events][#switch_events#][rules][#rules#][sign]']
							],
						],
						[
							'width' => 'five wide condition_params condition_p1', 
							'params' => [
								'placeholder' => rl3('Value 2'), 
								'origin' => ['name' => 'Connection['.$utype.']['.$n.'][switch_events][#switch_events#][rules][#rules#][second]']
							],
						],
						[
							...
							'params' => [
								...
								'origin' => ['name' => 'Connection['.$utype.']['.$n.'][switch_events][#switch_events#][rules][#rules#][msecond][]']
							],
						],
						[
							'width' => 'two wide', 
