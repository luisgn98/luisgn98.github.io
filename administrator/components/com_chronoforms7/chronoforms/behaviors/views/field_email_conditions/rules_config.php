					...
					'r1' => [
						[
							...
							'params' => [
								...
								'origin' => ['name' => 'Connection['.$utype.']['.$n.'][email_conditions][#email_conditions#][rules][#rules#][first]']
							],
						],
						[
							'width' => 'three wide', 
							...
							'params' => [
								...
								'origin' => ['name' => 'Connection['.$utype.']['.$n.'][email_conditions][#email_conditions#][rules][#rules#][sign]']
							],
						],
						[
							...
							'params' => [
								...
								'origin' => ['name' => 'Connection['.$utype.']['.$n.'][email_conditions][#email_conditions#][rules][#rules#][second]']
							],
						],
						[
							...
							'params' => [
								...
								'origin' => ['name' => 'Connection['.$utype.']['.$n.'][email_conditions][#email_conditions#][rules][#rules#][msecond][]']
							],
						],
						[
							'width' => 'two wide', 
